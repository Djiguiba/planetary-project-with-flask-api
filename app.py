...
def super_simple():
    return jsonify(message= 'Hello from the planetary API app!',
                   name= 'My name is Adams and I\'m the webmaster of this page.'), 200
...
def parameters():
    ...
    if age < 18:
        return jsonify(message='Sorry ' + name + ', your are too younger!')
    else:
        return jsonify(message='Welcome ' + name + ', you are the required age!')
